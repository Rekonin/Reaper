    ...
    ---- / Default Color / ----
    local R_Back_Default =  38;
    local G_Back_Default =  38;
    local B_Back_Default =  38;
    
    local R_Text_Default = 130;
    local G_Text_Default = 130;
    local B_Text_Default = 130;
    
    local R_Gui__Default = 64;
    local G_Gui__Default = 64;
    local B_Gui__Default = 64;
