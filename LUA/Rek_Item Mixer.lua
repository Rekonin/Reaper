...
local knb1 = Knob:new(6,6,40,50,   0.1,0.3,0.5,1, "K1", "Arial", 14, 0.5)
local knb2 = Knob:new(52,6,40,50,   0.1,0.3,0.5,1, "K2", "Arial", 14, 0.5)
local Knob_TB = {knb1,knb2}

local sldr1 = V_Slider:new(6,52,40,360, 0.4,0.4,0.4,1, "Sldr1", "Arial", 14, 0.66)
local sldr2 = V_Slider:new(52,52,40,360, 0.4,0.4,0.4,1, "Sldr2", "Arial", 14, 0.66)
